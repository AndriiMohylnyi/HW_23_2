...
public class MyLoginPage extends MyBasePage {
    ...
    public MyLoginPage() throws MalformedURLException {
        super();
    }
    ...
    public MyMainPage login(String userName, String userPassword) throws MalformedURLException {
    ...
    public MyLoginPage unsuccessfulLogin(String userName, String userPassword) throws MalformedURLException {
        setUserName(userName)
                .setUserPassword(userPassword)
                .clickLoginButton();
